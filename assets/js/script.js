const translations = {
    en: {
        ...
        deploy_koyeb: "Deploy to Koyeb",
        deploy_heroku: "Deploy to Heroku",
    ...
    si: {
        ...
        auto_deploy_title: "ස්වයංක්‍රීය ස්ථාපනය",
        deploy_koyeb: "Koyeb හි ස්ථාපනය කරන්න",
        deploy_heroku: "Heroku හි ස්ථාපනය කරන්න",
        deploy_railway: "Railway හි ස්ථාපනය කරන්න",
        guide_title: "ස්ථාපන මාර්ගෝපදේශය",
        guide_subtitle: "පියවරෙන් පියවර උපදෙස්",
        step1_title: "Repository එක Fork කරන්න:",
        step1_desc: "පළමුව, නිල CIPTER-MD Github repository එක ඔබගේ Github ගිණුමට Fork කරගන්න.",
        step2_title: "Session ID එක ලබාගන්න:",
        step2_desc: "අපගේ 'Connect Bot' පිටුවට ගොස් QR එක Scan කර හෝ Pairing Code එකක් මගින් ඔබගේ SESSION_ID එක ලබාගන්න.",
        step3_title: "Platform එක සම්බන්ධ කරන්න:",
        step3_desc: "ඉහත ඇති Auto Deploy බොත්තමක් (උදා: Koyeb) ඔබා ඔබගේ Github ගිණුම ඊට සම්බන්ධ කරන්න.",
        step4_title: "Variables සැකසීම:",
        step4_desc: "පහතින් දක්වා ඇති Environment Variables අදාළ තැන්වලට Copy-Paste කරගන්න.",
        step5_title: "Deploy කිරීම:",
        step5_desc: "අවසානයේ 'Deploy' බොත්තම ඔබා Build වීම අවසන් වනතුරු රැඳී සිටින්න. ඉන්පසු බොට් ක්‍රියාත්මක වනු ඇත!",
