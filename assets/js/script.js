const translations = {
    en: {
        ...
        method_termux_title: "<i class=\"fa-solid fa-mobile-screen-button\" style=\"color: #00f0ff;\"></i> Termux (Android)",
        method_termux_desc: "Run directly on your phone. <strong style=\"color: #ff4757;\">Important:</strong> Download Termux from <a href=\"https://f-droid.org/en/packages/com.termux/\" target=\"_blank\" style=\"color:var(--accent-cyan); text-decoration:underline;\">F-Droid</a> (Play Store version is obsolete).",
        ...
        update_date_2_0: "May 2026",
        update_20_1: "Launched the official Web Interface.",
        update_20_2: "Initial public release of project download links.",
        update_20_3: "Project reached ~10,000 lines of solid code without empty spaces.",
        update_20_4: "Focus shifted to stability, optimization, and bug fixing.",
        update_date_1_8: "April 2026",
        update_18_1: "Massive expansion: Reached 85 total commands.",
        update_18_2: "Integrated advanced API-based commands.",
        update_date_1_5: "February 2026",
        update_15_1: "Reached 35 total commands with brand new features.",
        update_15_2: "Continuous weekly updates and performance enhancements.",
        update_date_1_1: "December 2025",
        update_11_1: "Expanded to 16 commands (10 Admin, 6 User), including .birthday, .ai, .ping.",
        update_11_2: "Added Group commands, bringing the total to 25.",
        update_11_3: "Integrated MongoDB for proper database management.",
        update_11_4: "Migrated hosting from local Ubuntu laptop to Railway cloud servers.",
        update_date_1_0: "November 2025",
        update_10_1: "Project initiated! Hosted locally on PC via QR code scan.",
        update_10_2: "Initial commands created: .weather, .song, .video. No web interface yet.",
    ...
    si: {
        ...
        method_termux_title: "<i class=\"fa-solid fa-mobile-screen-button\" style=\"color: #00f0ff;\"></i> Termux (Android)",
        method_termux_desc: "ඔබගේ දුරකථනයෙන්ම කෙලින්ම Run කරන්න. <strong style=\"color: #ff4757;\">වැදගත්:</strong> අනිවාර්යයෙන්ම Termux එක Play Store එකෙන් නොගෙන <a href=\"https://f-droid.org/en/packages/com.termux/\" target=\"_blank\" style=\"color:var(--accent-cyan); text-decoration:underline;\">F-Droid</a> එකෙන් බාගන්න.",
        ...
        nav_faq: "නිතර අසන ප්‍රශ්න (FAQ)",
        footer_connect: "සම්බන්ධ වන්න",
        updates_title: "අලුත් වෙනස්කම් (Changelog)",
        updates_subtitle: "මෑත කාලීන යාවත්කාලීන කිරීම්",
        update_date_2_0: "මැයි 2026",
        update_20_1: "නිල වෙබ් අතුරුමුහුණත ආරම්භ කිරීම.",
        update_20_2: "ප්‍රථම වතාවට Project Download Links ලොවට නිකුත් කිරීම.",
        update_20_3: "හිස්තැන් රහිතව සම්පූර්ණ Code පේළි 10,000කට ළඟා වීම.",
        update_20_4: "Error fix කිරීම් සහ Performance වැඩි දියුණු කිරීම් වලට අවධානය යොමු කිරීම.",
        update_date_1_8: "අප්‍රේල් 2026",
        update_18_1: "විශාල ව්‍යාප්තිය: Commands 85 දක්වා වැඩි කිරීම.",
        update_18_2: "API මත පදනම් වූ උසස් Commands එක් කිරීම.",
        update_date_1_5: "පෙබරවාරි 2026",
        update_15_1: "අලුත් Features සමග Commands 35ක් දක්වා වර්ධනය වීම.",
        update_15_2: "සෑම සතියකම නව Updates ලබා දීම සහ ක්‍රියාකාරීත්වය වැඩි කිරීම.",
        update_date_1_1: "දෙසැම්බර් 2025",
        update_11_1: "Commands 16 දක්වා වැඩි වීම (10 Admin, 6 User). .birthday, .ai, .ping එක් වීම.",
        update_11_2: "Group commands සමගින් මුළු Commands ගණන 25ක් දක්වා වැඩි වීම.",
        update_11_3: "දත්ත කළමනාකරණය සඳහා MongoDB සාර්ථකව සම්බන්ධ කිරීම.",
        update_11_4: "Local Ubuntu ලැප්ටොප් එකෙන් Railway Cloud සර්වර් වෙත Project එක ගෙන යාම.",
        update_date_1_0: "නොවැම්බර් 2025",
        update_10_1: "Project එක ආරම්භ වීම! Local PC එකේ QR Code එක හරහා සම්බන්ධ කිරීම.",
        update_10_2: "මූලික Commands සෑදීම: .weather, .song, .video. (තවම වෙබ් එකක් නැත).",
